    ...
    <div>
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
          <DialogHeader>
            <DialogTitle>Updated Profile</DialogTitle>
          </DialogHeader>
          <form onSubmit={submitHandler}>
            <div className="grid gap-4 py-4 ">
              ...
              <div className="grid grid-cols-4 items-center ml-4 gap-4">
              ...
              <div className="grid grid-cols-4 ml-4 items-center gap-4">
              ...
              <div className="grid grid-cols-4 ml-4 items-center gap-4">
                ...
                <Input id="files" name="files" type="file" onChange={fileChangeHandler} accept="application/pdf" className="col-span-3" />
              </div>
            </div>
            <DialogFooter>
              {loading ? (
